...
$sitename = "CSGOBET.US - История противостояний между игроками";
$title = "$sitename";
...
?> </span> </div>
				...
				<div style="padding-right: 1px; padding-left: 1px; width: 742px; float: right;" class="content">
					<div style="width: 742px;background: #2E2E2E;" class="history_game">
						<h2 style="text-decoration: underline;background: #2e2e2e; border-radius: 0px; text-align: left; padding-left: 29px; font-family: Calibri; font-size: 13pt; font-weight: bold;"><?php echo $msg[$lang]["history"]; ?></h2>
						...
						<ul style="background: #2E2E2E;">
							...
							$winnername = fetchinfo("name","users","steamid",$lastwinner);
							echo '
							<li style="border-radius: 0px;border-bottom: 1px #3a3a3a solid;background: #2E2E2E;">
								<div style="border: 0;padding-right: 0px;" class="visual">
									<img style="border: 3px #232323 solid;" src="'.$winneravatar.'" width="105" height="105">
									<span class="num">№ '.$row["id"].'</span>
								</div>
								<div class="list" style=" margin-right: 50px; margin-bottom: 10px;">
									<ul>
										<li style="background: #222222; width: 206px; height: 28px; margin: 0px 0px 7px 0px; text-align: left; padding: 8px 14px 0px; color: #f4be03; font-family: Calibri; font-weight: bold; font-size: 16px;">'.$winnername.'</li>
										<li style="background: #222222; width: 206px; height: 28px; margin: 0px 0px 7px 0px; text-align: left; padding: 8px 14px 0px; color: #f4be03; font-family: Arial; font-weight: normal; font-size: 16px;">
											<span style="color: #fff; font-size: 13px;">'.$msg[$lang]["wcha"].':</span>
											<span style="color: #F4BE0C; font-size: 14px;" class="price">'.round($winnerpercent,1).'%</span>
										</li>
										<li style="background: #222222; width: 206px; height: 28px; margin: 0px 0px 7px 0px; text-align: left; padding: 8px 14px 0px; color: #f4be03; font-family: Arial; font-weight: normal; font-size: 16px;">
											<span style="color: #fff; font-size: 13px;">'.$msg[$lang]["wwin"].':</span>
											<span style="color: #CC3335; font-size: 14px; class="price">$'.round($winnercost,2).'</span>
										</li>
									</ul>
								</div>
								<div class="stuff" style="padding: 0px;float: none; width: 100%">
									<ul>';
								$rs2 = mysql_query("SELECT * FROM `game".$row["id"]."`");
								while($row2 = mysql_fetch_array($rs2)) {
									echo '
										<li style="background: #202020; border: 1px solid #ffc600; width: 47px; height: 43px;">
											<a style="padding: 4px 4px;" href="#">
												<img style="width: 39px; height: 38px;" src="http://steamcommunity-a.akamaihd.net/economy/image/'.$row2["image"].'/60fx60f" width="60" height="60">
