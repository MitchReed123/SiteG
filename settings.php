				...
				<div style="padding-left: 8px;width: 194px;background: #1c1c1c;margin-right: 0px;" class="sidebar">
					...
					<img style="margin-left: -3px;  margin-bottom: 10px;" src="image/levaia/logo.png" alt="logo">
						<ul style="background: none;padding: 5px 0px;background: #1c1c1c;list-style-type: none;">
							...
							<li style="padding-top: 0px; padding-bottom: 0px; width: 192px; height: 34px; background: url(image/levaia/5.png); font-size: 10pt; font-family: Arial; text-align: left; margin-bottom: 6px;"><a style="padding-left: 45px;background: none;padding-top: 4px;" href="/rls.php"><?php echo $msg[$lang]["rules"]; ?></a></li>
...
?> </span> </div>
				...
				<div style="padding-right: 1px; padding-left: 1px; width: 742px; float: right;" class="content">
					...
					<form method="POST" action="./updatelink.php">
						<h2 style="text-decoration: underline;background: #2e2e2e; border-radius: 0px; text-align: left; padding-left: 29px; font-family: Calibri; font-size: 13pt; font-weight: bold;">Настройки</h2>
						<img style="margin-left: 27.5px; margin-right: 27.5px;" src="image/p.png">
						<div style="background: #2E2E2E;padding: 30px;padding-top: 1px;">
						<p style="text-align: center;color: #eee; font-size: 14pt;">Ссылка на обмен: </p>
						<input type="text" name="link" style="width: 100%;min-width: 600px; height: 25px; margin-top: 10px;" id="link" value="<?php	echo fetchinfo("tlink","users","steamid",$_SESSION["steamid"]); ?>" placeholder="Ссылка на обмен">
						<p style="text-align: center;color: #eee; font-size: 14pt;">Получить ссылку можно тут - <a href="http://steamcommunity.com/id/me/tradeoffers/privacy#trade_offer_access_url" target="_blank" style="color: #eee; font-size: 12pt;">http://steamcommunity.com/id/me/tradeoffers/privacy</a></p>
						<p style="text-align: center;color: #eee; font-size: 12pt;">Обязательно откройте инвентарь в Steam!</p>
						<p style="text-align: center;color: #eee; font-size: 12pt;">Если вы указали НЕПРАВИЛЬНУЮ ссылку на оффер, администрация в праве не вернуть вещи.</p>
			        	<input style="margin-left: 260px; margin-right: 260px;width: 145px; background: #cb3434; border: 0; height: 42px; font-size: 12pt; font-family: calibri; font-weight: bold; text-align: center; padding-top: 0px; margin-top: 0px; margin-bottom: 0px; border-radius: 0px; text-shadow: none;" type="submit" class="btn" href="#" value="Сохранить">
			        	</div>
		        	</form>
					</div>
				</div>
				<img style="margin-left: 985px; margin-top: -957px;" src="image/bg.png">
</body>
</html>